        ...
        servers = {
          ["*"] = {
            ...
            keys = {
              ...
              -- goto (standard vim conventions, keep as-is)
              { "gd", "<cmd>Telescope lsp_definitions<cr>", desc = "LSP: Goto Definition", has = "definition" },
              ...
              -- <leader>l for LSP actions
              { "<leader>lt", "<cmd>Telescope lsp_type_definitions<cr>", desc = "LSP: [T]ype Definition" },
              -- { "<leader>ld", "<cmd>Telescope diagnostics<cr>", desc = "LSP: [D]iagnostics" },
              { "<leader>lr", vim.lsp.buf.rename, desc = "LSP: [R]ename", has = "rename" },
              {
                "<leader>la",
